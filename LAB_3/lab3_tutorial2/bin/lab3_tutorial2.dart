...
/* using optional parameter
  // --> Writing [String? title] makes title optional. If you don’t pass in a value for title, then it will have the value of null..
...
/* Using anonymous functions
  //To call the function that the variable multiply refers to,
    simply use the variable name followed by the arguments in
    parentheses:
...
/* Mini Exercises 
  ...
  final result = youAreWonderful(name:"jashpal");
  print(result);
*/
/*
  print(multiply(5, 3));
